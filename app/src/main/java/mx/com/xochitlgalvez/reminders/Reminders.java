...
// public class RemindersActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setAdapter(mCursorAdapter);   // antes: mListView.setAdapter(arrayAdapter);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int masterListPosition, long id) {
                ...
                ArrayAdapter<String> modeAdapter = new ArrayAdapter<>(Reminders.this,
                ...
                modeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 0) {
                            ...
                            // cambio null x Listener
                            new TimePickerDialog(Reminders.this,listener,today.getHours(),today.getMinutes(),false).show();
                        }
                        dialog.dismiss();
                    }
                });
  ...
  // All recuerdos son importantes_check_box);
